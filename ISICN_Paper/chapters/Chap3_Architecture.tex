...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{figures/ETL_Pipeline.jpeg} %specify width
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{figures/Data_vectorization.jpeg} %specify width
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{figures/LLM_Pipeline.jpeg} %specify width
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{figures/THS_Rebuttal_view.jpeg} %specify width
	\end{center}
