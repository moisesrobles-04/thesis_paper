...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{figures/ETL_Pipeline.jpeg} %specify width
	\end{center}
...
%We extracted 5,000 IDs for each topic.
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{figures/Data_vectorization.jpeg} %specify width
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{figures/LLM_Pipeline.jpeg} %specify width
	\end{center}
...
%Context_finder_process
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{figures/Context_finder_process.png} %specify width
	\end{center}
	\caption{Context Finder Example} %specify caption
	\label{fig:cfe}
\end{figure}
