...
training data related to the tasks it will perform. However, there are multiple training types. We will focus on Sequence Classification \textbf{[REFERENCE]} and Causal Language Modeling \textbf{[REFERENCE]}.
