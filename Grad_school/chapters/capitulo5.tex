...
The results present that most LLMs outperformed the THS model. Now, we preprocessed the data in both datasets to change links, mentions, and hashtags into special tokens. The training
