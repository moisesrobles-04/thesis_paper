...
their respective tokens. Any URL was replaced by \textit{[LINK]}, mentions by \textit{[MENTION]}, and hashtags by \textit{[HASHTAG]}. That allows us to keep the elements and give them some importance in the text.

%\begin{table}[H]
%	\centering
%	\caption{Misinformation Dataset}
%	\begin{tabular}{||c | c||} 
%		\hline
%		\textbf{Category} & \textbf{\# of records} \\ [1.5ex] 
%		\hline
%		Misinformation & 3638  \\ [1ex]
%		\hline
%		Not Misinfomation & 5111  \\[1ex]
%		\hline
%	\end{tabular}
%	\label{table:misinformation}
%\end{table}
...
We identified three models to perform these classification tasks. The models used for this experiment are Bert, T5, and LLaMa-2. Each one has a different architecture, as shown in Table \ref{table:LLM}. 
