...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.35\textwidth]{figures/ETL_Pipeline.jpeg} %specify width
	\end{center}
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.35\textwidth]{figures/LLM_Pipeline.jpeg} %specify width
	\end{center}
