...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{figures/Data_vectorization.jpeg} %specify width
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.45\textwidth]{figures/Table_diagram.jpeg} %specify width
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.45\textwidth]{figures/LLM_Pipeline.jpeg} %specify width
	\end{center}
